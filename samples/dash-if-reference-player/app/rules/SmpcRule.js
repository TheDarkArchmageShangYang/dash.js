...
function SmpcRuleClass(config) {
    ...
    function getMaxIndex(rulesContext) {
        try {
            ...
            console.log("cal jiange, in smpc, sum: ", diff_arr, current_err, cur_state, currentQuality, currentBitrate, throughput);
            ...
            console.log("running time/ms: ", mpc_end - mpc_start, next_q, next_q.bit);
            ...
            if (switchRequest.quality !== currentQuality) {
                console.log('[SmpcRule][' + mediaType + '] requesting switch to index: ', switchRequest.quality, 'Average throughput', Math.round(throughput), 'kbps');
            }
...
SmpcRuleClass.__dashjs_factory_name = 'SmpcRule';
SmpcRule = dashjs.FactoryMaker.getClassFactory(SmpcRuleClass);