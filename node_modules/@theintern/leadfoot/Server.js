...
var Server = /** @class */ (function () {
    ...
    Server.prototype._sendRequest = function (method, path, requestData, pathParts) {
        ...
        var kwArgs = __assign({}, this.requestOptions, { followRedirects: false, handleAs: 'text', httpAgent: this._httpAgent, httpsAgent: this._httpsAgent, headers: headers,
            method: method });
        if (requestData) {
    ...
    Server.prototype._detectCapabilities = function (session) {
        ...
        var discoverFeatures = function () {
            ...
            if (capabilities.usesWebDriverMoveBase == null) {
                testedCapabilities.usesWebDriverMoveBase = function () {
                    return get("<!DOCTYPE html><html><body style=\"width:100%;height:100px;\">\n              <script>\n                var events = [];\n                document.onmousemove = function (event) {\n                  events.push({\n                    x: event.clientX,\n                    y: event.clientY\n                  });\n                };\n              </script>\n            </body></html>\n            ")
                        .then(function () { return session.moveMouseTo(100, 50); })
                        .then(function () {
                        return session.execute('return window.events');
                    })
        ...
        var discoverDefects = function () {
            ...
            if (capabilities.brokenParentFrameSwitch == null) {
                testedCapabilities.brokenParentFrameSwitch = function () {
                    return session.serverPost('frame/parent').then(works, broken);
                };
            }
